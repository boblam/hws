      ...
      <nav class='tabbable tabs-left hidden-phone' id='tabnav'>
        <ul class='nav nav-tabs'>
          <li class='active'> <a href='#'>
            <div class='iconnav'> <img alt='My Big Campus' src='./images/schoolwork.png'> <span>我的作业</span> </div>
            </a> </li>
          
          <li > <a href="${ctx}/teaReleaseHwForm">
          ...
          <div class="list-tables">
            <table class="table table-striped table-hover">
              <tbody id = "tbodyPage">
                <tr>
                  <th class="name">名称</th>
                  <th class="due">开始时间</th>
                  <th class="due">截止时间</th>
                  <th class="status">状态</th>
                  <th class="grade">班级</th>
                  <th class="type">类型</th>
                   <th class="type">操作</th>
                </tr>
                <!-- <tr>
                  ...
                  <td class="due">2012-10-17 (已过期)</td>
                  <td>已提交</td>
                  <td></td>
                  <td>电子版</td>
                  <td>发布作业</td>
