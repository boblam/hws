		...
		this.each(function(i, cont) {
			...
			var newList = {
				...
				grabItem: function(e) {
					...
					/** drag item html **/
					dupHTML = $('<div>').append(list.draggedItem.clone()).remove().html(); //XXX
					/** drag item html **/
					...
					if (!opts.dragBetween||list.draggedItem.attr("nodragbetween")) { //XXX
					...
					list.draggedItem.addClass("draggingItem");
				...
				dropItem: function() {
					...
					var placeHolderListidx = list.placeHolderItem.parents().attr("data-listidx"); //XXX
					...
					/** leave original copy of dragged item  */	// added by James Li
					if(list.draggedItem.attr("clone") && placeHolderListidx == "2"){
						$("[data-dropTarget]").last().after(dupHTML);
						list.draggedItem.removeAttr("clone");
						list.draggedItem.addClass("cloned");
						list.draggedItem.attr("nodragbetween", "true"); 
					}
					/** leave original copy of dragged item **/ 
					...
					//Add by jim. remove class draggingItem
					list.draggedItem.removeClass("draggingItem");
					list.draggedItem.find(".subnav").hide();
				...
				swapItems: function(e) {
					...
					var nlist = list;
					for (var i = 0; ei == -1 && (opts.dragBetween&&!list.draggedItem.attr("nodragbetween")) && i < lists.length; i++) {
