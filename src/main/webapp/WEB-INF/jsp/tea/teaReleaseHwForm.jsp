...
-->
		...
		<div class="container">
			<div class="row-fluid nav_wrap">
				<div class="span2 logo">
					<a href="#" title="最代码网站"><img src="/resource/img/logo.png"
						alt="logo">作业本</a>
				</div>
				...
				<div class="span2 user">
					<a href="login.html" rel="nofollow">登录</a>&nbsp;&nbsp; <a
	...
	<div class="container-fluid margin_top15">
		<div class="row-fluid">
			<!--left nav bar-->
			<nav class="span1" id="#secondary-navbar"> <nav
				class="tabbable tabs-left hidden-phone" id="tabnav">
			<ul class="nav nav-tabs">
				
				<li class="active"><a href="${ctx}/login.do"> <%-- "${ctx}/logout.do" --%>
						<div class="iconnav">
							<img alt="My Big Campus" src="./images/schoolwork.png"> <span>作业本</span>
						</div>
				</a></li>
				<li><a href='#'>
						<div class='iconnav'>
							<img alt='My Big Campus' src='./images/schoolwork.png'> <span>活动</span>
						</div>
				</a></li>
				<li><a href='#'>
						<div class='iconnav'>
				...
				<li><a href='#'>
						<div class='iconnav'>
							<img alt='My Big Campus' src='./images/schoolwork.png'> <span>消息</span>
						</div>
				</a></li>
			</ul>
			</nav> <nav class="tabbable visible-phone" id="tabtopnav">
			<ul class="nav nav-tabs">
				<!-- <li> <a href="/activity">
          ...
          <li> <a href="/schools/my-big-campus-sample-school">
			...
			<form accept-charset="UTF-8" action="${ctx}/releaseHomeWork.do"
				class="form-horizontal" enctype="multipart/form-data"
				id="homeWorkForms" method="post">
				<div style="margin: 0; padding: 0; display: inline">
					<input name="utf8" type="hidden" value="✓"> <input
						name="_method" type="hidden" value="put"> <input
						name="authenticity_token" type="hidden"
						value="CTYowTDfcJnPSS1IznTxmVZBm/AIoSU4z1yc2fuq+Xg=">
				</div>
				<div class="control-group">
					<label class="control-label" for="user_first_name">班级名称</label>
					<div class="controls">
						<!--   <input class="short"  id="user_first_name" name="user[first_name]" size="30" type="text" value="09信管2班"> -->
						<select name="className" id="classNameSelector" onchange="">
				...
				<div class="control-group">
					...
					<div class="controls">
						<!--   <input class="short" id="user_last_name" name="user[last_name]" size="30" type="text" value="计算机网络"> -->
						<select name="courseName" id="courseSelector"
							onchange="performSchoolworkSearch();">
						</select>
					</div>
				</div>
				<!--end-课程名称-->
				...
				<div class="control-group">
					...
					<div class="controls">
						<input class="short" id="user_last_name" name="homeWorkName"
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea class="short" id="#" name="work_desc" type="text"
							height="100" value=""></textarea>
					</div>
				</div>
				<!--end-作业描述-->
				<!--布置日期-->
				<div class="control-group">
					...
					<div class="controls">
						<input class="short" id="start-date" name="start_date" size="30"
							type="text" value=""
							onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm',maxDate:'#F{$dp.$D(\'end-date\')||\'2020-10-01\'}'})" />
					</div>
				</div>
				<!--end-布置日期-->
				<!--到期日期-->
				<div class="control-group">
					...
					<div class="controls">
						<input class="short" id="end-date" name="end_date" size="30"
							type="text" value=""
							onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm',minDate:'#F{$dp.$D(\'start-date\')}',maxDate:'2020-10-01'})" />
					</div>
				</div>
				<!--end-到期日期-->
				<!--是否开启-->
				<div class="control-group">
					...
					<div class="controls">
						<input class="short" id="user_last_name" name="user[last_name]"
							size="30" type="text" value="">
					</div>
				</div>
				<!--end-是否开启-->
				...
				<div class="control-group">
					...
					<div class="controls">
						<input class="short" id="user_last_name" name="attachment"
				...
				<div class="form-actions">
					<input class="btn btn-primary" data-disable-with="Saving"
						name="commit" type="submit" value="保存发布">
				</div>
			</form>
			</section>
			<!--right body-->
